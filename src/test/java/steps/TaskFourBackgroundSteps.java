...
public class TaskFourBackgroundSteps {
...
//    @Given("database table is created")
    public void databaseTableIsCreated() throws SQLException {
    ...
    @When("you select agent by name (.*)$")
    public void youSelectAgentByNameLucida(String agentName) throws SQLException {
            String query2 = "SELECT * FROM lecture_1.agents2 where AGENT_NAME ='" + agentName + "'";
            resultSet = stmt.executeQuery(query2);
        }


    @Then("selected data is correct")
    public void selectedDataIsCorrect() throws SQLException {
