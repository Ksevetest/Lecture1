...
public class TaskFourHookSteps {
    ...
    @When("^I select agent by name (.*)$")
    public void agentLucidaIsSelectedByQuery(String agentName) throws Exception {
    ...
    public void dataShouldBeCorrect() throws SQLException {
